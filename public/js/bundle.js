...
var organicVsPaidChart = function organicVsPaidChart(selector, graphs) {
  var chartOrganicVsPaid = document.getElementById("".concat(selector)).getContext('2d');
...
var organicComparison = function organicComparison(selector, graphs) {
  ...
  for (var i = 0; i < graphs.length; i++) {
    ...
    if (i == 5) {
      bgColor = 'rgba(135, 135, 135, 0.2)', bdColor = 'rgba(128, 128, 128, 1)';
    }
...
if (document.getElementById('paidComparison')) {
  ...
  var paidComparison = new Chart(chartPaidComparison, {
    type: 'line',
    data: {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logging you out please wait..');
              window.setTimeout(function () {
                location.assign('/');
              }, 500);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Error logging out. Please try again in a moment.');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            if (_context.t0.response.data.message.includes('. ')) {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message.split('. ')[1]);
            } else {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"sendFeedback.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Thank you for your feedback! We'll try improve your experience :)");
          ...
          case 7:
            ...
            if (_context.t0.response.data.message.includes('. ')) {
              reversed = _context.t0.response.data.message.split('. ').reverse();
              (0, _alerts.showAlert)('error', reversed[0]);
            } else {
              (0, _alerts.showAlert)('error', _context.t0.response.data.message);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"forgotPass.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Reset link sent successfully, do check your inbox or spam within 24hrs.");
...
var resetPass = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(password, confirmPassword, path) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(path),
              data: {
                password: password,
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Password updated successfully, Logging you in..");
  ...
  return function resetPass(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();

exports.resetPass = resetPass;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/is-valid-domain/data/sldMap.json":[function(require,module,exports) {
module.exports = {
  "com.ac": true,
  "net.ac": true,
  "gov.ac": true,
...
},{}],"../../node_modules/is-valid-domain/index.js":[function(require,module,exports) {
...
},{"./data/sldMap.json":"../../node_modules/is-valid-domain/data/sldMap.json"}],"checkDomain.js":[function(require,module,exports) {
"use strict";
...
var checkDomain = function checkDomain(domain) {
  var res = (0, _isValidDomain.default)(domain);

  if (res === true) {
    return true;
  } else {
    (0, _alerts.showAlert)('error', 'Sorry, the domain name is not valid.');
...
},{"is-valid-domain":"../../node_modules/is-valid-domain/index.js","./alerts":"alerts.js"}],"../../node_modules/email-validator/index.js":[function(require,module,exports) {
"use strict";
...
},{}],"checkEmail.js":[function(require,module,exports) {
"use strict";
...
var checkEmail = function checkEmail(email) {
  var res = _emailValidator.default.validate(email);

  if (res === true) {
    return true;
  } else {
    (0, _alerts.showAlert)('error', "Sorry, can't register with this email.");
    document.getElementById('btn--register').innerHTML = '<i class="fas fa-user-plus me-2"></i>Sign Up';
    document.getElementById('btn--register').disabled = false;
    return false;
  }
...
},{"email-validator":"../../node_modules/email-validator/index.js","./alerts":"alerts.js"}],"register.js":[function(require,module,exports) {
"use strict";
...
var register = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(regUser, user_id) {
    var domain_id, competitorSites, domainData, res, result, _res, justAnotherAsyncFunction, _res4;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            domain_id = '';
            competitorSites = []; //this object is needed to save domain

            domainData = {}; //Check if regUser.domain already exists in db, if so get that domain, save to a variable and update domain_id field''
            //else
          ...
          case 6:
            ...
            if (res.data.status === 'success') {
              ...
              domainData = res.data.data; //console.log(`this iz domainID${domain_id}, this iz domainData ${domainData}`);
            }
          ...
          case 19:
            ...
            (0, _alerts.showAlert)('error', 'Sorry, something went wrong while fetching your website data. Please try again..');
          ...
          case 26:
            ...
            if (_res.data.status === 'success') {
              domain_id = _res.data.data.data._id; // console.log(domain_id, domainData);
            }
          ...
          case 30:
            ...
            (0, _alerts.showAlert)('error', 'Sorry, something went wrong while saving your data. Please try again..');
            return _context2.abrupt("return", false);
          ...
          case 34:
            ...
            justAnotherAsyncFunction = /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(domainData) {
                var _iterator, _step, site, _res2, _result, _res3;

                return regeneratorRuntime.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        _iterator = _createForOfIteratorHelper(domainData.similarSites.siteName);
                        _context.prev = 1;
                      ...
                      case 8:
                        ...
                        if (_res2.data.status === 'success') {
                          competitorSites.push(_res2.data.data._id); // console.log(competitorSites);
                        }
                      ...
                      case 16:
                        ...
                        domainData = _result.data.data; //save each domainData to database and push id to competitorSites[]
                      ...
                      case 21:
                        ...
                        if (_res3.data.status === 'success') {
                          competitorSites.push(_res3.data.data.data._id); // console.log(competitorSites);
                        }
                      ...
                      case 25:
                        ...
                        (0, _alerts.showAlert)('error', 'Some data of your competition could not be processed.');
                ...
                }, _callee, null, [[1, 32, 35, 38], [5, 12], [18, 25]]);
              }));

              return function justAnotherAsyncFunction(_x3) {
                return _ref2.apply(this, arguments);
              };
            }();

            _context2.next = 37;
            return justAnotherAsyncFunction(domainData);
          ...
          case 37:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/users/update/".concat(user_id),
              data: {
                domain_id: domain_id,
          ...
          case 44:
            ...
            // console.log(err);
            (0, _alerts.showAlert)('error', 'Sorry, something went very wrong while saving your data. Please try again later.');
    ...
    }, _callee2, null, [[3, 10], [12, 19], [23, 30], [37, 44]]);
  }));
...
var createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(regUser, signup) {
    var res, user_id;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(signup),
              data: regUser
            });
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            alert = _args.length > 1 && _args[1] !== undefined ? _args[1] : true;
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.default)({
              method: 'DELETE',
          ...
          case 4:
            ...
            if (alert === true) (0, _alerts.showAlert)('success', 'User successfully deleted!');
          ...
          case 10:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); // if (err.response.data.message.includes('. ')) {
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteFeedback.js":[function(require,module,exports) {
"use strict";
...
var deleteFeedback = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/feedbacks/".concat(id)
            });
          ...
          case 3:
            ...
            (0, _alerts.showAlert)('success', 'Feedback successfully deleted!');
            return _context.abrupt("return", 'success');
  ...
  return function deleteFeedback(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteFeedback = deleteFeedback;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"newAdmin.js":[function(require,module,exports) {
"use strict";
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(user_id) {
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (user_id) (0, _alerts.showAlert)('success', 'New admin created successfully!');
...
},{"./alerts":"alerts.js"}],"toggleStatus.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.toggleUserStatus = void 0;
...
var toggleUserStatus = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/users/toggleUserStatus/".concat(user_id)
            });
          ...
          case 9:
            _context.prev = 9;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Something went wrong while changing account status.');
  ...
  return function toggleUserStatus(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
var _forgotPass = require("./forgotPass");

var _resetPass = require("./resetPass");

var _checkDomain = require("./checkDomain");

var _checkEmail = require("./checkEmail");
...
var _deleteFeedback = require("./deleteFeedback");

var _newAdmin = require("./newAdmin");

var _toggleStatus = require("./toggleStatus");
...
var profileForm = document.querySelector('.form--profile');
var pwToggle = document.querySelector('.pwToggle');
var pwToggleConfirm = document.querySelector('.pwToggleConfirm');
var btnSuggestion = document.getElementById('suggestion');
var btnSomethingWrong = document.getElementById('somethingWrong');
var btnCompliment = document.getElementById('compliment');
...
var newAdminForm = document.querySelector('.form--newAdmin');
...
if (document.getElementById('organicVsPaid')) {
  var graphs = JSON.parse(document.getElementById('organicVsPaid').dataset.graphs);
  (0, _charts.organicVsPaidChart)('organicVsPaid', graphs);
}

if (document.getElementById('organicVsPaidSecond')) {
  var _graphs = JSON.parse(document.getElementById('organicVsPaidSecond').dataset.graphs);

  (0, _charts.organicVsPaidChart)('organicVsPaidSecond', _graphs);
}

if (document.getElementById('organicVsPaidThird')) {
  var _graphs2 = JSON.parse(document.getElementById('organicVsPaidThird').dataset.graphs);

  (0, _charts.organicVsPaidChart)('organicVsPaidThird', _graphs2);
}

if (document.getElementById('organicVsPaidFourth')) {
  var _graphs3 = JSON.parse(document.getElementById('organicVsPaidFourth').dataset.graphs);

  (0, _charts.organicVsPaidChart)('organicVsPaidFourth', _graphs3);
}

if (document.getElementById('organicVsPaidFifth')) {
  var _graphs4 = JSON.parse(document.getElementById('organicVsPaidFifth').dataset.graphs);

  (0, _charts.organicVsPaidChart)('organicVsPaidFifth', _graphs4);
}

if (document.getElementById('organicVsPaidSixth')) {
  var _graphs5 = JSON.parse(document.getElementById('organicVsPaidSixth').dataset.graphs);

  (0, _charts.organicVsPaidChart)('organicVsPaidSixth', _graphs5);
}

if (document.getElementById('organicComparison')) {
  var _graphs6 = JSON.parse(document.getElementById('organicComparison').dataset.graphs);

  (0, _charts.organicComparison)('organicComparison', _graphs6);
}
...
if (registerForm) {
  registerForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(event) {
      var fullName, userName, email, password, confirmPassword, domainName, user_id, out;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              if (userName === '') userName = undefined; //Check if email exists

              if (!((0, _checkEmail.checkEmail)(email) === false)) {
                _context.next = 12;
                break;
              }
            ...
            case 12:
              if (!((0, _checkDomain.checkDomain)(domainName) === false)) {
                _context.next = 14;
                break;
              }
            ...
            case 14:
              _context.next = 16;
              return (0, _createUser.createUser)({
                fullName: fullName,
                userName: userName,
                email: email,
                password: password,
            ...
            case 24:
              ...
              _context.next = 31;
              return (0, _deleteUser.deleteUser)(user_id);
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 6;
              return (0, _forgotPass.forgotPass)(email);
...
if (resetForm) {
  resetForm.addEventListener('submit', function (event) {
    ...
    (0, _resetPass.resetPass)(password, confirmPassword, path);
  });
}
...
if (profileForm) {
  profileForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(event) {
      var form, currentPassword, newPassword, confirmPassword;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              _context3.next = 13;
              return (0, _updateUser.updateProfile)(form);
...
if (pwToggle) {
  pwToggle.addEventListener('click', function (event) {
    event.preventDefault();
    var password = document.querySelector('#password'); // toggle & set the type attribute

    var type = password.getAttribute('type') === 'password' ? 'text' : 'password';
    password.setAttribute('type', type); // toggle eye slash icon
...
if (pwToggleConfirm) {
  pwToggleConfirm.addEventListener('click', function (event) {
    event.preventDefault();
    var password = document.querySelector('#confirmPassword'); // toggle & set the type attribute
...
if (btnSuggestion) {
  btnSuggestion.addEventListener('click', function (event) {
    event.preventDefault();
    btnSuggestion.parentElement.childNodes.forEach(function (el) {
...
if (btnSomethingWrong) {
  btnSomethingWrong.addEventListener('click', function (event) {
    event.preventDefault();
    btnSomethingWrong.parentElement.childNodes.forEach(function (el) {
      if (el.classList.contains('select-btn')) {
        el.classList.remove('select-btn');
      }
    });
...
if (btnCompliment) {
  btnCompliment.addEventListener('click', function (event) {
    event.preventDefault();
    btnCompliment.parentElement.childNodes.forEach(function (el) {
      if (el.classList.contains('select-btn')) {
        el.classList.remove('select-btn');
      }
    });
        ...
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _context4.next = 9;
              return (0, _sendFeedback.sendFeedback)({
                rating: rating,
                category: category,
                message: message
              });
...
if (adminOverviewTable) {
  document.querySelectorAll('.btn-delete').forEach(function (btn) {
    btn.addEventListener('click', function (event) {
      ...
      var user_id = event.target.parentNode.parentNode.getAttribute('id');
      document.getElementById('confirmUserDelete').addEventListener('click', /*#__PURE__*/function () {
        var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
          var status, userCount;
              ...
              switch (_context5.prev = _context5.next) {
                ...
                case 2:
                  ...
                  if (status == 'success') {
                    ...
                    document.getElementById("".concat(user_id)).remove();
                    userCount = parseInt(document.getElementById('userCount').textContent);
  ...
  document.querySelectorAll('.slider').forEach(function (btn) {
        ...
        return regeneratorRuntime.wrap(function _callee6$(_context6) {
          while (1) {
            switch (_context6.prev = _context6.next) {
              case 0:
                user_id = event.target.parentNode.parentNode.parentNode.getAttribute('id');
                _context6.next = 3;
                return (0, _toggleStatus.toggleUserStatus)(user_id);
...
if (adminFeedbackTable) {
  document.querySelectorAll('.btn-delete').forEach(function (btn) {
    btn.addEventListener('click', function (event) {
      // let email
      //console.log(event.target.parentNode.parentNode.childNodes[2].getAttribute('value'));
      var feedback_id = event.target.parentNode.parentNode.getAttribute('id');
      document.getElementById('confirmFeedbackDelete').addEventListener('click', /*#__PURE__*/function () {
          ...
          return regeneratorRuntime.wrap(function _callee7$(_context7) {
            while (1) {
              switch (_context7.prev = _context7.next) {
                case 0:
                  _context7.next = 2;
                  return (0, _deleteFeedback.deleteFeedback)(feedback_id);
                ...
                case 2:
                  ...
                  if (status == 'success') {
                    //update table
                    document.getElementById("".concat(feedback_id)).remove();
                  }
...
if (newAdminForm) {
  newAdminForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref8 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee8(event) {
      var fullName, userName, email, password, confirmPassword, role, user_id;
      return regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 17:
              _context8.next = 19;
              return (0, _newAdmin.newAdmin)(user_id);
